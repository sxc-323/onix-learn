...
#define PAGE(idx) ((u32)idx <<12)   // 获取页索引idx 对应的页开始的位置
...
void memory_init(u32 magic,u32 addr)
{
    ...
    {
        panic("Memory init magic unknowm 0x%p\n",magic);
    }
    ...
    {
        panic("System memory is %dM too small,at last %dM needed\n",
...
void memory_test()
{
    ...
    // 将20 M 0x1400000 内存映射到64M 0x4000000 的位置
